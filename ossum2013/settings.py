# Django settings for ossum2013 project.
...
MEDIA_ROOT = os.path.join(HTDOCS_PATH, "media")
...
STATIC_ROOT = os.path.join(HTDOCS_PATH, "static")
...
SECRET_KEY = 'hqsj33ml5guaqv&ac8-a2-cgipugr42d+i739$^@l2@)l0bpbk'
